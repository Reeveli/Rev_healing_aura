/*
	...
	[[line1,line2],"SIDE",0.15,true] execVM "simpleConv.sqf";
...
private _fnc_showSubtitles =
{
	...
	// Show subtitle
	_text = parseText format ["<t align = 'center' shadow = '2' size = '0.6'><t color = '%1'>" + _from + ":</t> <t color = '#FFFFFF'>" + _text + "</t></t>",_colourHTML];
